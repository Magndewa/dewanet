...
<body>
    ...
    <!--HOME   <h2>About <br> DEWA.NET/</h2> -->
    <section id="about-home">
        <div class="part">
            <div class="descrpt">
                <h3>WEBSITE CREATION AGENCY</h3>
                <p>DEWANET is a website creation agency based in Lomé. 
                    We imagine the creation and development of your SEO-optimized 
                    and responsive website with personalized management. 
                    We also offer marketing actions and computer training at home, 
                    remotely or on our premises.</p>
            </div>
            <div class="imgbox">
                <span><h1>Website Creation in Lome </h1></span>
            </div>
        </div>
    </section>
    <video width="320" height="240" autoplay>
        <source src="video/Ref.mp4" type="video/mp4">
    </video>


     <!--about members
         <section id="members">
        <h2>ABOUT EACH MEMBER</h2>
        <div class="slierder active">
        ...
        <div class="previous"><i class="fa fa-chevron-circle-left" aria-hidden="true"></i></div>
    </section>
    ...
    <script>
        function mySlider() {
            let slierder = document.getElementsByClassName('slierder');
        let etape = 0;

        let nbr_slierder= slierder.length;

        let next= document.querySelector('.next');
        let previous= document.querySelector('.previous');

        function enleverActiveSlider() {
            for (let i = 0; i < nbr_slierder; i++) {
                slierder[i].classList.remove('active'); 
            } 
        }
        ...
        next.addEventListener('click', function()
        {
            etape++;
            enleverActiveSlider();
            slierder[etape].classList.add('active');
    ...
    <footer>
        <div class="row">
            <div class="col">
                <img src="images/logo_dewanet.JPG" alt="Logo">
                <p>Suscribe And learn for free to become a master</p>
            </div>
            <div class="col">
                <h3>Office <div class="underline"><span></span></div> </h3>
                <p>27, Rue Dewa</p>
                <p>Lome, Maritime</p>
                <p>Agoe-Zongo, PIN 00078, Togo</p>
                <p class="email-id">dewanet@contact.com</p>
                <h4>+228 93 79 41 82</h4>
            ...
            <div class="col">
                ...
                <div class="social-icons">
                    <i id="fase" class="fa-brands fa-facebook"></i>
                    <i id="fase" class="fa-brands fa-youtube"></i>
                    <i id="fase" class="fa-brands fa-twitter"></i>
                    <i id="fase" class="fa-brands fa-whatsapp-square"></i>
                </div>
            </div>
        </div>
        <hr>
        <p class="copyright">© 2022 Dewanet All Rights Reserved</p>
    </footer>
